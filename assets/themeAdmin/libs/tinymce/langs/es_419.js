...
"Inline": "En l\u00ednea",
"Blocks": "Bloques",
"Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.": "Pegar ahora está en modo de texto sin formato. Los contenidos ahora se pegarán como texto sin formato hasta que desactive esta opción",
"Fonts": "Fuentes",
...
"Disc": "Disc",
"Square": "Cuadrado",
"Lower Alpha": "Minúscula Alpha",
"Lower Greek": "Minúscula Greek",
"Lower Roman": "Minúscula Roman",
"Upper Alpha": "Mayúscula Alpha",
"Upper Roman": "Mayúscula Roman",
"Anchor...": "Ancho...",
"Name": "Nombre",
"Id": "Id",
"Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.": "La identificación debe comenzar con una letra, seguida solo de letras, números, guiones, puntos, dos puntos o guiones bajos.",
"You have unsaved changes are you sure you want to navigate away?": "Tiene cambios sin guardar, ¿está seguro de que desea navegar fuera?",
...
"Emoticons...": "Emoticones...",
"Metadata and Document Properties": "Propiedades de metadatos y documentos",
"Title": "Título",
...
"Image title": "Título imagen",
"Border width": "Ancho del borde",
"Border style": "Stilo dle borde",
"Error": "Error",
"Warn": "Peligro",
"Valid": "Validar",
"To open the popup, press Shift+Enter": "Para abrir el popup, presione Shift+Enter",
"Rich Text Area. Press ALT-0 for help.": "Rich Text Area. Press ALT-0 for help.",
"System Font": "Fuente de sistema",
"Failed to upload image: {0}": "Fallo la carga de imagen: {0}",
"Failed to load plugin: {0} from url {1}": "Fallo la carga de plugin: {0} desde url {1}",
"Failed to load plugin url: {0}": "Fallo la carga de plugin url: {0}",
"Failed to initialize plugin: {0}": "Fallo la inicialización del plugin: {0}",
"example": "Ejemplo",
"Search": "Buscar",
"All": "Todos",
"Currency": "Currency",
