...
<div class="card" id="<?php echo (preg_replace('([^A-Za-z0-9])', '', strtolower($content_header))) ?>" >
    <div class="card-body">
        <div class="form-group">
            <label for="exampleInputEmail1"><b>URL de Github (*)</b></label>
            <input type="url" minlength="4" required name="nombre" id="nombre" onblur="searchurl(this.value)" class="form-control" aria-describedby="nombre" placeholder="Url de Github">
            <br><button type="button" name="buscar" onclick="searchurl()" id="buscar"  class="btn btn-primary float-end"><i class="fa fa-search"></i> Buscar</button><br>
        </div>
